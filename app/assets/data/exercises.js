        ...
        "exercises": [
            {
                ...
                "preCommand": "$('[s]').removeAttr('s');",
                "postCommand": "(function(){var expected = $('h1').get(); window.isCorrect = (function(a, b) {var l = a.length; if (l !== b.length) { return false; } while (l--) { if (a[l] !== b[l]) { return false; } } return true;}($('[s]').get(), expected));}());",
                "commandSuffix": ".attr('s', function() {return $(this).data('correct') ? '✓' : 'x';});",
                "userData": {
                    "answer": null,
                    "htmlResult": null,
                    "timestamp": 0
            ...
            },
            {
                ...
                "preCommand": "$('[s]').removeAttr('s');",
                "postCommand": "(function(){var expected = $('h2').get(); window.isCorrect = (function(a, b) {var l = a.length; if (l !== b.length) { return false; } while (l--) { if (a[l] !== b[l]) { return false; } } return true;}($('[s]').get(), expected));}());",
                "commandSuffix": ".attr('s', function() {return $(this).data('correct') ? '✓' : 'x';});",
                "userData": {
                    "answer": null,
                    "htmlResult": null,
            ...
            },
            {
                ...
                "preCommand": "$('[s]').removeAttr('s');",
                "postCommand": "(function(){var expected = $('li').get(); window.isCorrect = (function(a, b) {var l = a.length; if (l !== b.length) { return false; } while (l--) { if (a[l] !== b[l]) { return false; } } return true;}($('[s]').get(), expected));}());",
                "commandSuffix": ".attr('s', function() {return $(this).data('correct') ? '✓' : 'x';});",
                "userData": {
                    "answer": null,
                    "htmlResult": null,
